            ...
            <div class="main-content">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('complaints.index') }}" class="row g-3 align-items-end mb-4">
                        ...
                        <div class="col-md-3 d-flex align-items-end gap-3">
                            ...
                            <a href="{{ route('complaints.index') }}" class="link-button">Clear</a>
                        </div>
                    </form>
                ...
                <div class="modal fade" id="addComplaintModal" tabindex="-1" aria-labelledby="addComplaintModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ route('complaints.store') }}" method="POST" class="modal-content">
                            @csrf
...
<script>
    const updateRouteTemplate = `{!! route('complaints.update', ['id' => 'COMPLAINT_ID']) !!}`;
</script>
