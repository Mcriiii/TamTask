                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route($prefix .'violations.destroy', $violation->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this violation?');">
                                            @csrf
                                            @method('DELETE')
