                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{ route($routePrefix . 'violations.destroy', $v->id) }}" class="d-inline" onsubmit="return confirm('Are you sure?');">
                                            @csrf @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    editModal.addEventListener('show.bs.modal', function (event) {
        ...
        form.action = `/${'{{ $routePrefix }}'}violations/update/${id}`;
