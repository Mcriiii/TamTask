        ...
        <div class="main-wrapper">
            <div class="main-content">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="padding-bottom: 1.5rem;">
                    <h4 class="mb-0 fw-bold fs-3">Referral Reports</h4>
                    <button type="button" class="btn text-dark fw-bold" style="background-color: #FFD100; border: none;" data-bs-toggle="modal" data-bs-target="#addReferralModal">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route($prefix . 'referrals.index') }}" class="row g-3 mb-4">
                        ...
                        <div class="col-md-2 d-flex align-items-end gap-3">
                            ...
                            <a href="{{ route($prefix . 'referrals.index') }}" class="link-button">Clear</a>
                        </div>
                    </form>
                        ...
                        <table class="modern-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="text-button text-primary me-3" data-bs-toggle="modal" data-bs-target="#editReferralModal"
                                            data-id="{{ $referral->id }}"
                                        ...
                                        <form method="POST" action="{{ route($prefix . 'referrals.destroy', $referral->id) }}"
                                            method="POST"
                                            class="d-inline"
