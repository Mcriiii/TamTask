...
<input type="hidden" id="edit_base_url" value="{{ url('admin/lost-found') }}">
            ...
            <div class="card shadow rounded">
                ...
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        // ✅ Read the hidden input value for proper base URL
                        ...
                        editModal.addEventListener('show.bs.modal', function(event) {
                            ...
                            // ✅ Set correct action URL with admin prefix
                            form.action = `${baseUrl}/${button.getAttribute('data-id')}`;
