        ...
        <div class="main-wrapper">
            <div class="main-content">
                <div class="card-header text-black d-flex justify-content-between align-items-center" style="padding-bottom: 1.5rem;">
                    <h4 class="mb-0 fw-bold fs-3">Certificate Requests</h4>
                    <button type="button" class="btn text-dark fw-bold" style="background-color: #FFD100; border: none;" data-bs-toggle="modal" data-bs-target="#addCertificateModal">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route($prefix . 'certificates.index') }}" class="row g-3 mb-4">
                        ...
                        <div class="col-md-3 d-flex align-items-end gap-3">
                            ...
                            <a href="{{ route($prefix . 'certificates.index') }}" class="link-button">Clear</a>
                        </div>
                    </form>
                        ...
                        <table class="modern-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- ✅ View Button -->
                                        <button class="text-button text-primary me-3"
                                            data-bs-toggle="modal"
                                        ...
                                        <form action="{{ route($prefix . 'certificates.destroy', $certificate->id) }}"
                                            method="POST"
                                            class="d-inline"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editModal.addEventListener('show.bs.modal', function(event) {
            ...
            // 🛠 Set form action
            form.action = `{{ route($prefix . 'certificates.update', ['certificate' => 'CERT_ID']) }}`.replace('CERT_ID', id);
