                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('violations.destroy', $v->id) }}" onsubmit="return confirm('Are you sure?');">
                                            @csrf @method('DELETE')
...
<div class="modal fade" id="addViolationModal" tabindex="-1">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('violations.store') }}" class="modal-content">
            @csrf
