                ...
                <table class="modern-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@include('takeaction_case', ['violation' => $v])</td>
                            <td>
                                <div class="d-flex flex-nowrap align-items-center gap-1 justify-content-center">
                                    ...
                                    <form method="POST"
                                        action="{{ route('violations.destroy', $v->id) }}"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editModal.addEventListener('show.bs.modal', function(event) {
            ...
            // Use prefix variable from Blad

            form.action = `{{ route('violations.update', ':id') }}`.replace(':id', id);
