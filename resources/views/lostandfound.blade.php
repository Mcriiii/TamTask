        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="GET" action="{{ route('lost-found.export.pdf') }}" class="row g-2 align-items-end mb-4">
                        <div class="col-md-3">
                    ...
                    <form method="GET" action="{{ route('lost-found.index') }}" class="row g-3 mb-4">
                        ...
                        <div class="col-md-3 d-flex align-items-end gap-3 justify-content-between">
                            <div>
                                ...
                                <a href="{{ route('lost-found.index') }}" class="link-button">Clear</a>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('lost-found.destroy', $report->id) }}"
                                            method="POST"
                                            class="d-inline"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" id="editForm"
                                        action="{{ old('_modal') === 'edit' && session('edit_id') ? route('lost-found.update', session('edit_id')) : '' }}">
                                        @csrf
                                        @method('PUT')
